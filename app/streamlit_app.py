...
from app.utils import load_audio   # only needed for visualization
from app.app_logger import setup_logger

#  PUT YOUR RENDER API URL HERE
API_URL = "https://deepfake-audio-detector-5.onrender.com/predict"
...
if uploaded_file:
    ...
    # 🔥 Call FastAPI instead of local model
    ...
    # 🔊 Load audio ONLY for visualization
    audio, sr = load_audio(file_path)
